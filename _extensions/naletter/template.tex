...
$else$
\IfFileExists{_extensions/nareal/naletter/um-eeg}{
  \sbox{\letterlogo}{\hbox{\includegraphics[]{_extensions/nareal/naletter/um-eeg}}}
}{
...
\usebox{\letterto}
\end{textblock}
\begin{textblock}{10}(2,3.8)\usebox{\letterinstaddress}\end{textblock}\def\thepage{}}
...
$if(fromaddress)$
\sbox{\letterinstaddress}{\parbox{10cm}{\fontsize{9}{11}\sffamily\color[gray]{0.4}{$fromaddress$}}}
$endif$
