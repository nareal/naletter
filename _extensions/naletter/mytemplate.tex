...
\sbox{\letterlogo}{\hbox{\includegraphics[]{_extensions/naletter/um-eeg}}}


\newlength{\junkw}

\makeatletter
\def\ps@eeg{\begin{textblock}{8}(10,1)
\usebox{\letterlogo}
\end{textblock}
\begin{textblock}{6}(2,6)
\usebox{\letterfrom}
\end{textblock}
\begin{textblock}{6}(10,6)
\usebox{\letterto}
\end{textblock}
\begin{textblock}{10}(2,3.8)\usebox{\letterfooter}\end{textblock}\def\thepage{}}

\@ifundefined{opening}{}{%
\renewcommand*{\opening}[1]{\thispagestyle{eeg}%
  {\@date\par}%
  \vspace{2\parskip}%
  #1\par\nobreak}}
\makeatother
...
\sbox{\letterto}{\parbox{10cm}{\fontsize{10}{12}\sffamily
{$toname$ \\ $toaddress$}}}


\sbox{\letterfooter}{\hbox{\fontsize{9}{11}\sffamily\color[gray]{0.4}\begin{tabular}{@{}ll@{}}
\multicolumn{2}{@{}l}{School of Economics and Management}\\
\multicolumn{2}{@{}l}{University of Minho}\\
\multicolumn{2}{@{}l}{Campus de Gualtar}\\
\multicolumn{2}{@{}l}{4710-057 Braga - Portugal}\\
\end{tabular}}}
...
\setstretch{$spacing$}
$body$
\closing{$closing$\\[0.5cm]$fromname$}
\end{letter}
